...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 15, 2024 at 12:01 AM
...
(193, 'Can add Translation', 47, 'add_translation'),
(194, 'Can change Translation', 47, 'change_translation'),
(195, 'Can delete Translation', 47, 'delete_translation'),
(196, 'Can view Translation', 47, 'view_translation');

-- --------------------------------------------------------

--
-- Table structure for table `base_administrativestaff`
--
...
--
-- Table structure for table `base_administrativestafftype`
--
...
--
-- Table structure for table `base_administrativestaff_type_staff`
--

CREATE TABLE `base_administrativestaff_type_staff` (
  `id` bigint NOT NULL,
  `administrativestaff_id` bigint NOT NULL,
  `administrativestafftype_id` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `base_agecategory`
--
...
--
-- Dumping data for table `base_agecategory`
--
...
--
-- Table structure for table `base_arena`
--
...
--
-- Dumping data for table `base_arena`
--
...
--
-- Table structure for table `base_breedingservice`
--
...
--
-- Table structure for table `base_breedingservicetype`
--
...
--
-- Table structure for table `base_breedingservice_type_service`
--

CREATE TABLE `base_breedingservice_type_service` (
  `id` bigint NOT NULL,
  `breedingservice_id` bigint NOT NULL,
  `breedingservicetype_id` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Dumping data for table `base_city`
--
...
--
-- Table structure for table `base_clothes`
--
...
CREATE TABLE `base_clothes` (
  ...
  `created` datetime(6) NOT NULL,
  `updated` datetime(6) NOT NULL,
  `age_category_id` bigint DEFAULT NULL,
...
--
-- Dumping data for table `base_clothes`
--
...
--
-- Table structure for table `base_clothestype`
--
...
--
-- Dumping data for table `base_clothestype`
--
...
--
-- Table structure for table `base_clothes_materials`
--
...
--
-- Dumping data for table `base_clothes_materials`
--
...
--
-- Table structure for table `base_clothes_media_links`
--
...
--
-- Dumping data for table `base_clothes_media_links`
--
...
--
-- Table structure for table `base_clothes_size`
--
...
--
-- Dumping data for table `base_clothes_size`
--
...
--
-- Table structure for table `base_coachstaff`
--
...
CREATE TABLE `base_coachstaff` (
  ...
  `created` datetime(6) NOT NULL,
  `updated` datetime(6) NOT NULL,
  `statistics_id` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `base_coachstaff`
--
...
--
-- Table structure for table `base_coachstafftype`
--
...
--
-- Dumping data for table `base_coachstafftype`
--
...
--
-- Table structure for table `base_coachstaff_type_coach`
--

CREATE TABLE `base_coachstaff_type_coach` (
  `id` bigint NOT NULL,
  `coachstaff_id` bigint NOT NULL,
  `coachstafftype_id` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `base_coachstaff_type_coach`
--
...
--
-- Table structure for table `base_coachsummarystatistics`
--
...
CREATE TABLE `base_coachsummarystatistics` (
  ...
  `defeats` int DEFAULT NULL,
  `point_scored` int DEFAULT NULL,
...
--
-- Table structure for table `base_color`
--
...
--
-- Dumping data for table `base_color`
--
...
--
-- Table structure for table `base_director`
--
...
--
-- Table structure for table `base_directortype`
--
...
--
-- Table structure for table `base_director_type_director`
--

CREATE TABLE `base_director_type_director` (
  `id` bigint NOT NULL,
  `director_id` bigint NOT NULL,
  `directortype_id` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `base_footballer`
--
...
--
-- Dumping data for table `base_footballer`
--
...
--
-- Table structure for table `base_footballerposition`
--
...
--
-- Dumping data for table `base_footballerposition`
--
...
--
-- Table structure for table `base_footballerstatistics`
--
...
CREATE TABLE `base_footballerstatistics` (
  ...
  `starting_lineup` int DEFAULT NULL,
  `came_substitute` int DEFAULT NULL,
  `been_replaced` int DEFAULT NULL,
  `goals` int DEFAULT NULL,
  `yellow_cards` int DEFAULT NULL,
  `red_cards` int DEFAULT NULL,
  `minutes_played` int DEFAULT NULL,
  `ball_selection` int DEFAULT NULL,
...
--
-- Dumping data for table `base_footballerstatistics`
--
...
--
-- Table structure for table `base_footballerstatistics_penalties`
--

CREATE TABLE `base_footballerstatistics_penalties` (
  `id` bigint NOT NULL,
  `footballerstatistics_id` bigint NOT NULL,
  `penaltyscored_id` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `base_footballerstatistics_penalties`
--
...
--
-- Table structure for table `base_footballer_image`
--
...
--
-- Dumping data for table `base_footballer_image`
--
...
--
-- Table structure for table `base_gallery`
--
...
--
-- Dumping data for table `base_gallery`
--

INSERT INTO `base_gallery` (`id`, `created`, `updated`, `cover`, `description`, `title`) VALUES
(1, '2024-10-14 18:46:37.783823', '2024-10-14 20:21:46.230510', 'gallery/covers/cover.jpg', '', 'Gallery #1'),
(3, '2024-10-14 20:23:44.516528', '2024-10-14 20:23:44.516528', 'cover.jpg', 'Default Gallery Description', 'Default Gallery Title'),
(4, '2024-10-14 20:24:49.886101', '2024-10-14 20:24:49.886101', 'cover.jpg', 'Default Gallery Description', 'Default Gallery Title');

-- --------------------------------------------------------

--
-- Table structure for table `base_gallery_media`
--
...
--
-- Dumping data for table `base_gallery_media`
--
...
--
-- Table structure for table `base_gender`
--
...
--
-- Dumping data for table `base_gender`
--
...
--
-- Table structure for table `base_generalstatisticsall`
--
...
CREATE TABLE `base_generalstatisticsall` (
  ...
  `created` datetime(6) NOT NULL,
  `updated` datetime(6) NOT NULL,
  `neutral_field_id` bigint DEFAULT NULL,
  `own_field_id` bigint DEFAULT NULL,
  `someone_field_id` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `base_generalstatisticsall`
--
...
--
-- Table structure for table `base_generalstatisticstournament`
--
...
--
-- Dumping data for table `base_generalstatisticstournament`
--
...
--
-- Table structure for table `base_goalkeeperstatistics`
--
...
--
-- Dumping data for table `base_goalkeeperstatistics`
--
...
--
-- Table structure for table `base_headermodel`
--
...
--
-- Table structure for table `base_match_teams`
--
...
--
-- Dumping data for table `base_match_teams`
--
...
--
-- Table structure for table `base_neutralfield`
--
...
--
-- Dumping data for table `base_neutralfield`
--
...
--
-- Table structure for table `base_news`
--
...
--
-- Dumping data for table `base_news`
--
...
--
-- Table structure for table `base_outcome`
--
...
--
-- Dumping data for table `base_outcome`
--
...
--
-- Table structure for table `base_ownfield`
--
...
--
-- Dumping data for table `base_ownfield`
--
...
--
-- Table structure for table `base_penaltyscored`
--

CREATE TABLE `base_penaltyscored` (
  `id` bigint NOT NULL,
  `kicked` int DEFAULT NULL,
...
--
-- Dumping data for table `base_penaltyscored`
--
...
--
-- Table structure for table `base_season`
--
...
--
-- Dumping data for table `base_season`
--
...
--
-- Table structure for table `base_size`
--
...
--
-- Dumping data for table `base_size`
--
...
--
-- Table structure for table `base_someonefield`
--
...
--
-- Dumping data for table `base_someonefield`
--
...
CREATE TABLE `base_team` (
  ...
  `created` datetime(6) NOT NULL,
  `updated` datetime(6) NOT NULL,
  `all_statistics_id` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 'ZSK', '2024-10-14 19:35:02.331759', '2024-10-14 19:35:02.331759', 1);

-- --------------------------------------------------------

--
-- Table structure for table `base_team_administrative_staff`
--
...
--
-- Table structure for table `base_team_coach_staff`
--
...
--
-- Dumping data for table `base_team_coach_staff`
--
...
--
-- Table structure for table `base_team_footballers`
--
...
--
-- Dumping data for table `base_team_footballers`
--
...
--
-- Table structure for table `base_team_tournaments_statistics`
--

CREATE TABLE `base_team_tournaments_statistics` (
  `id` bigint NOT NULL,
  `team_id` bigint NOT NULL,
  `generalstatisticstournament_id` bigint NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `base_team_tournaments_statistics`
--
...
--
-- Table structure for table `base_ticketplace`
--
...
--
-- Dumping data for table `base_ticketplace`
--
...
--
-- Table structure for table `base_tournament_cities`
--
...
--
-- Dumping data for table `base_tournament_cities`
--
...
--
-- Table structure for table `base_tournament_matches`
--
...
--
-- Dumping data for table `base_tournament_matches`
--
...
(2, 'pbkdf2_sha256$600000$6Y1FkVNzx1Tue1dip1gGMW$9/ulRzpdeq0gTLPBIrj+hqo/oAX2vJMJuWeu7Cv5Ls4=', '2024-10-14 19:06:25.562916', 1, '', '', 1, 1, '2024-10-14 19:06:20.299135', 'AdminX', NULL, 'admin@example.com', NULL, NULL, 'assets/img/icons/avatar.svg', '2024-10-14 19:06:20.794060', '2024-10-14 19:06:20.794060');
...
(96, '2024-10-14 19:35:02.343339', '3', 'ZSK', 1, '[{\"added\": {}}]', 41, 2),
(97, '2024-10-14 20:01:44.306791', '1', 'Gallery #1', 2, '[{\"changed\": {\"fields\": [\"Cover\"]}}]', 21, 2),
(98, '2024-10-14 20:01:51.942922', '2', 'Gallery #2', 1, '[{\"added\": {}}]', 21, 2),
(99, '2024-10-14 20:01:56.983532', '2', 'Gallery #2', 3, '', 21, 2),
(100, '2024-10-14 20:21:46.232523', '1', 'Gallery #1', 2, '[{\"changed\": {\"fields\": [\"Title\"]}}]', 21, 2),
(101, '2024-10-14 20:23:44.520645', '3', 'Gallery #3', 1, '[{\"added\": {}}]', 21, 2),
(102, '2024-10-14 20:24:49.890302', '4', 'Gallery #4', 1, '[{\"added\": {}}]', 21, 2);
...
(25, 'base', '0002_gallery_cover', '2024-10-14 20:00:33.505614'),
(26, 'base', '0003_gallery_description_gallery_title_and_more', '2024-10-14 20:16:09.250491'),
(27, 'base', '0004_alter_gallery_description_alter_gallery_title', '2024-10-14 20:21:19.254643'),
(28, 'base', '0005_translation', '2024-10-14 20:27:24.448417');
...
('1rd294ticl4v0hwh39lv03g46070it1u', '.eJxVjEsOwjAMBe-SNYqo0yQOS_Y9QxXHNi2gRupnhbg7VOoCtm9m3sv0eVuHfltk7kc2FwPm9LtRLg-ZdsD3PN2qLXVa55HsrtiDLrarLM_r4f4dDHkZvrVqQWEURInMTiEmnxlVGwjig8NEkeK5ib4FgkCeqcmgLQaC5IKa9wcF-jgp:1t0QOf:vVmbNsEpuD9MGN3yaUAh4WnUL-_Kc9Ng_87tqHiyleQ', '2024-10-28 19:06:25.565933'),
...
--
-- Indexes for table `base_administrativestaff`
--
ALTER TABLE `base_administrativestaff`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_administrativestafftype`
--
ALTER TABLE `base_administrativestafftype`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_administrativestaff_type_staff`
--
...
--
-- Indexes for table `base_agecategory`
--
ALTER TABLE `base_agecategory`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_arena`
--
ALTER TABLE `base_arena`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_brand`
--
ALTER TABLE `base_brand`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_breedingservice`
--
ALTER TABLE `base_breedingservice`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_breedingservicetype`
--
ALTER TABLE `base_breedingservicetype`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_breedingservice_type_service`
--
...
--
-- Indexes for table `base_city`
--
ALTER TABLE `base_city`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_clothes`
--
...
--
-- Indexes for table `base_clothestype`
--
ALTER TABLE `base_clothestype`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_clothes_materials`
--
...
--
-- Indexes for table `base_clothes_media_links`
--
...
--
-- Indexes for table `base_clothes_size`
--
...
--
-- Indexes for table `base_coachstaff`
--
...
--
-- Indexes for table `base_coachstafftype`
--
ALTER TABLE `base_coachstafftype`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_coachstaff_type_coach`
--
...
--
-- Indexes for table `base_coachsummarystatistics`
--
ALTER TABLE `base_coachsummarystatistics`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_color`
--
ALTER TABLE `base_color`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_director`
--
ALTER TABLE `base_director`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_directortype`
--
ALTER TABLE `base_directortype`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_director_type_director`
--
...
--
-- Indexes for table `base_footballer`
--
...
--
-- Indexes for table `base_footballerposition`
--
ALTER TABLE `base_footballerposition`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_footballerstatistics`
--
ALTER TABLE `base_footballerstatistics`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_footballerstatistics_penalties`
--
...
--
-- Indexes for table `base_footballer_image`
--
...
--
-- Indexes for table `base_gallery`
--
ALTER TABLE `base_gallery`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_gallery_media`
--
...
--
-- Indexes for table `base_gender`
--
ALTER TABLE `base_gender`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_generalstatisticsall`
--
...
--
-- Indexes for table `base_generalstatisticstournament`
--
...
--
-- Indexes for table `base_goalkeeperstatistics`
--
...
--
-- Indexes for table `base_headermodel`
--
ALTER TABLE `base_headermodel`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_match`
--
...
--
-- Indexes for table `base_match_teams`
--
...
--
-- Indexes for table `base_material`
--
...
--
-- Indexes for table `base_neutralfield`
--
ALTER TABLE `base_neutralfield`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_news`
--
ALTER TABLE `base_news`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_outcome`
--
ALTER TABLE `base_outcome`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_ownfield`
--
ALTER TABLE `base_ownfield`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_penaltyscored`
--
ALTER TABLE `base_penaltyscored`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_season`
--
ALTER TABLE `base_season`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_size`
--
ALTER TABLE `base_size`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_someonefield`
--
ALTER TABLE `base_someonefield`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_team`
--
...
--
-- Indexes for table `base_team_administrative_staff`
--
...
--
-- Indexes for table `base_team_coach_staff`
--
...
--
-- Indexes for table `base_team_footballers`
--
...
--
-- Indexes for table `base_team_tournaments_statistics`
--
...
--
-- Indexes for table `base_ticketplace`
--
ALTER TABLE `base_ticketplace`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_tournament`
--
ALTER TABLE `base_tournament`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `base_tournament_cities`
--
...
--
-- Indexes for table `base_tournament_matches`
--
...
--
-- Indexes for table `base_translation`
--
ALTER TABLE `base_translation`
  ADD PRIMARY KEY (`id`),
  ADD KEY `base_translation_match_id_f147348c_fk_base_match_id` (`match_id`);
...
--
-- AUTO_INCREMENT for table `base_administrativestaff`
--
ALTER TABLE `base_administrativestaff`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_administrativestafftype`
--
ALTER TABLE `base_administrativestafftype`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_administrativestaff_type_staff`
--
ALTER TABLE `base_administrativestaff_type_staff`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_agecategory`
--
ALTER TABLE `base_agecategory`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_arena`
--
ALTER TABLE `base_arena`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_brand`
--
ALTER TABLE `base_brand`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `base_breedingservice`
--
ALTER TABLE `base_breedingservice`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_breedingservicetype`
--
ALTER TABLE `base_breedingservicetype`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_breedingservice_type_service`
--
ALTER TABLE `base_breedingservice_type_service`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_city`
--
ALTER TABLE `base_city`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `base_clothes`
--
ALTER TABLE `base_clothes`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `base_clothestype`
--
ALTER TABLE `base_clothestype`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `base_clothes_materials`
--
ALTER TABLE `base_clothes_materials`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `base_clothes_media_links`
--
ALTER TABLE `base_clothes_media_links`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `base_clothes_size`
--
ALTER TABLE `base_clothes_size`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `base_coachstaff`
--
ALTER TABLE `base_coachstaff`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_coachstafftype`
--
ALTER TABLE `base_coachstafftype`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_coachstaff_type_coach`
--
ALTER TABLE `base_coachstaff_type_coach`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_coachsummarystatistics`
--
ALTER TABLE `base_coachsummarystatistics`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_color`
--
ALTER TABLE `base_color`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `base_director`
--
ALTER TABLE `base_director`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_directortype`
--
ALTER TABLE `base_directortype`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_director_type_director`
--
ALTER TABLE `base_director_type_director`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_footballer`
--
ALTER TABLE `base_footballer`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_footballerposition`
--
ALTER TABLE `base_footballerposition`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_footballerstatistics`
--
ALTER TABLE `base_footballerstatistics`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_footballerstatistics_penalties`
--
ALTER TABLE `base_footballerstatistics_penalties`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_footballer_image`
--
ALTER TABLE `base_footballer_image`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `base_gallery`
--
ALTER TABLE `base_gallery`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `base_gallery_media`
--
ALTER TABLE `base_gallery_media`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `base_gender`
--
ALTER TABLE `base_gender`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_generalstatisticsall`
--
ALTER TABLE `base_generalstatisticsall`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `base_generalstatisticstournament`
--
ALTER TABLE `base_generalstatisticstournament`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `base_goalkeeperstatistics`
--
ALTER TABLE `base_goalkeeperstatistics`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `base_headermodel`
--
ALTER TABLE `base_headermodel`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_match`
--
ALTER TABLE `base_match`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_match_teams`
--
ALTER TABLE `base_match_teams`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `base_material`
--
ALTER TABLE `base_material`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `base_neutralfield`
--
ALTER TABLE `base_neutralfield`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `base_news`
--
ALTER TABLE `base_news`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_outcome`
--
ALTER TABLE `base_outcome`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `base_ownfield`
--
ALTER TABLE `base_ownfield`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_penaltyscored`
--
ALTER TABLE `base_penaltyscored`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_season`
--
ALTER TABLE `base_season`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_size`
--
ALTER TABLE `base_size`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `base_someonefield`
--
ALTER TABLE `base_someonefield`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_team`
--
ALTER TABLE `base_team`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_team_administrative_staff`
--
ALTER TABLE `base_team_administrative_staff`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `base_team_coach_staff`
--
ALTER TABLE `base_team_coach_staff`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `base_team_footballers`
--
ALTER TABLE `base_team_footballers`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `base_team_tournaments_statistics`
--
ALTER TABLE `base_team_tournaments_statistics`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `base_ticket`
--
ALTER TABLE `base_ticket`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `base_ticketplace`
--
ALTER TABLE `base_ticketplace`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_tournament`
--
ALTER TABLE `base_tournament`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `base_tournament_cities`
--
ALTER TABLE `base_tournament_cities`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `base_tournament_matches`
--
ALTER TABLE `base_tournament_matches`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `base_translation`
--
ALTER TABLE `base_translation`
  MODIFY `id` bigint NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `base_administrativestaff_type_staff`
--
ALTER TABLE `base_administrativestaff_type_staff`
...
--
-- Constraints for table `base_breedingservice_type_service`
--
ALTER TABLE `base_breedingservice_type_service`
...
--
-- Constraints for table `base_clothes`
--
ALTER TABLE `base_clothes`
...
--
-- Constraints for table `base_clothes_materials`
--
ALTER TABLE `base_clothes_materials`
...
--
-- Constraints for table `base_clothes_media_links`
--
ALTER TABLE `base_clothes_media_links`
...
--
-- Constraints for table `base_clothes_size`
--
ALTER TABLE `base_clothes_size`
...
--
-- Constraints for table `base_coachstaff`
--
ALTER TABLE `base_coachstaff`
...
--
-- Constraints for table `base_coachstaff_type_coach`
--
ALTER TABLE `base_coachstaff_type_coach`
...
--
-- Constraints for table `base_director_type_director`
--
ALTER TABLE `base_director_type_director`
...
--
-- Constraints for table `base_footballer`
--
ALTER TABLE `base_footballer`
...
--
-- Constraints for table `base_footballerstatistics_penalties`
--
ALTER TABLE `base_footballerstatistics_penalties`
...
--
-- Constraints for table `base_footballer_image`
--
ALTER TABLE `base_footballer_image`
...
--
-- Constraints for table `base_gallery_media`
--
ALTER TABLE `base_gallery_media`
...
--
-- Constraints for table `base_generalstatisticsall`
--
ALTER TABLE `base_generalstatisticsall`
...
--
-- Constraints for table `base_generalstatisticstournament`
--
ALTER TABLE `base_generalstatisticstournament`
...
--
-- Constraints for table `base_goalkeeperstatistics`
--
ALTER TABLE `base_goalkeeperstatistics`
...
--
-- Constraints for table `base_match`
--
ALTER TABLE `base_match`
...
--
-- Constraints for table `base_match_teams`
--
ALTER TABLE `base_match_teams`
...
--
-- Constraints for table `base_team`
--
ALTER TABLE `base_team`
...
--
-- Constraints for table `base_team_administrative_staff`
--
ALTER TABLE `base_team_administrative_staff`
...
--
-- Constraints for table `base_team_coach_staff`
--
ALTER TABLE `base_team_coach_staff`
...
--
-- Constraints for table `base_team_footballers`
--
ALTER TABLE `base_team_footballers`
...
--
-- Constraints for table `base_team_tournaments_statistics`
--
ALTER TABLE `base_team_tournaments_statistics`
...
--
-- Constraints for table `base_ticket`
--
ALTER TABLE `base_ticket`
...
--
-- Constraints for table `base_tournament_cities`
--
ALTER TABLE `base_tournament_cities`
...
--
-- Constraints for table `base_tournament_matches`
--
ALTER TABLE `base_tournament_matches`
...
--
-- Constraints for table `base_translation`
--
ALTER TABLE `base_translation`
  ADD CONSTRAINT `base_translation_match_id_f147348c_fk_base_match_id` FOREIGN KEY (`match_id`) REFERENCES `base_match` (`id`);
