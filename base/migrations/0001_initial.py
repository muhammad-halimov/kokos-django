    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('breeding_service', models.ManyToManyField(blank=True, related_name='team_breeding_service', to='base.breedingservice')),
                ('coach_staff', models.ManyToManyField(blank=True, related_name='team_coach_staff', to='base.coachstaff')),
                ('directors', models.ManyToManyField(blank=True, related_name='team_directors', to='base.director')),
                ('football_players', models.ManyToManyField(blank=True, related_name='football_players', to='base.footballer')),
                ('staff', models.ManyToManyField(blank=True, related_name='team_staff', to='base.staff')),
        ...
        migrations.AddField(
            model_name='staff',
            name='type_staff',
            field=models.ManyToManyField(blank=True, related_name='staff_type', to='base.stafftype'),
        ),
        migrations.CreateModel(
            name='News',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('gallery', models.ManyToManyField(blank=True, related_name='news_gallery', to='base.gallery')),
            ],
            options={
                'verbose_name': 'News',
        ...
        migrations.AddField(
            model_name='gallery',
            name='media_links',
            field=models.ManyToManyField(blank=True, related_name='media_links', to='base.media'),
        ),
        migrations.AddField(
            model_name='gallery',
            name='teams',
        ...
        migrations.AddField(
            model_name='gallery',
            name='tournament',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.tournament'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='director',
            name='type_director',
            field=models.ManyToManyField(blank=True, related_name='_director_type', to='base.directortype'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='breedingservice',
            name='type_service',
            field=models.ManyToManyField(blank=True, related_name='type', to='base.breedingservicetype'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
